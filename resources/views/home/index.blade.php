        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                ...
                <a href="{{ route('lessons') }}"
                    class="bg-white text-green-500 font-bold py-3 px-8 rounded-2xl text-lg hover:bg-gray-100 transition">
                    Get Started
                </a>
            </div>
        </div>
    ...
    <div class="bg-green-500 text-white py-12">
        <div class="max-w-5xl mx-auto px-4 text-center">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                ...
                <a href="login.html"
                    class="bg-transparent border-2 border-white text-white font-bold py-3 px-8 rounded-2xl text-lg hover:bg-green-600 transition">
                    Log In
                </a>
            </div>
        </div>
